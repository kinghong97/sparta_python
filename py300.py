...
# user = int(input('주민등록번호: ').split("-")[1][0])
#
# if user == 1 or user == 3:
#     print('남자')
# else:
...
# user = int(input('주민등록번호: ').split("-")[1][1:3])
#
# 주민번호 = input("주민등록번호: ")
# 뒷자리 = 주민번호.split("-")[1]
# if 0 <= int(뒷자리[1:3]) <= 8:
...
#     volatility.append(int(high_prices[a]) - int(low_prices[a]))
# print(volatility)
